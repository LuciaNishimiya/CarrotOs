...
# Current dir — celeste pastel
: ${AGNOSTER_DIR_FG:=black}
: ${AGNOSTER_DIR_BG:=blue}

# user@host — rosita suave
: ${AGNOSTER_CONTEXT_FG:=black}
: ${AGNOSTER_CONTEXT_BG:=magenta}

# Git related
# limpio → celeste; sucio → rosado más fuerte para advertir
...
: ${AGNOSTER_BZR_CLEAN_BG:=cyan}
: ${AGNOSTER_BZR_DIRTY_FG:=black}
: ${AGNOSTER_BZR_DIRTY_BG:=red}

# Mercurial related
: ${AGNOSTER_HG_NEWFILE_FG:=black}
: ${AGNOSTER_HG_NEWFILE_BG:=magenta}
: ${AGNOSTER_HG_CHANGED_FG:=black}
: ${AGNOSTER_HG_CHANGED_BG:=cyan}
: ${AGNOSTER_HG_CLEAN_FG:=black}
: ${AGNOSTER_HG_CLEAN_BG:=cyan}

# VirtualEnv — lavanda suave
: ${AGNOSTER_VENV_FG:=black}
: ${AGNOSTER_VENV_BG:=blue}

# AWS — advertencias más serias, pero sin romper el estilo
: ${AGNOSTER_AWS_PROD_FG:=black}
: ${AGNOSTER_AWS_PROD_BG:=yellow}
: ${AGNOSTER_AWS_FG:=black}
: ${AGNOSTER_AWS_BG:=cyan}

# Status symbols — discreto, contrastado
